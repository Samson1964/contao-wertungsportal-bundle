...
$GLOBALS['TL_LANG']['tl_settings']['wertungsportal_cron_aus'] = array('Nächtliches Vorladen abschalten', 'Ohne diesen Haken holt ein Cronjob nachts zwischen 1 und 3 Uhr alle fünf Minuten die Auswertungen, Ergebnisse und Spielberichtsbögen der Turniere aus den letzten 30 Tagen in den Zwischenspeicher, sofern dort noch nichts liegt. Ohne das Vorladen wartet jeweils der erste Besucher einer Turnierseite auf die Schnittstelle. Jeder Lauf endet nach 20 Sekunden und der nächste macht dort weiter; der Lauf um 3 Uhr ist der letzte der Nacht. Erfolge stehen im Systemlog.');
