...
$GLOBALS['TL_LANG']['tl_settings']['wertungsportal_cron_aus'] = array('Tägliches Vorladen abschalten', 'Ohne diesen Haken holt ein täglicher Cronjob die Auswertungen, Ergebnisse und Spielberichtsbögen der Turniere aus den letzten 30 Tagen in den Zwischenspeicher, sofern dort noch nichts liegt. Ohne das Vorladen wartet jeweils der erste Besucher einer Turnierseite auf die Schnittstelle. Der Lauf bricht nach 20 Sekunden ab und macht am nächsten Tag weiter; Erfolge stehen im Systemlog.');
