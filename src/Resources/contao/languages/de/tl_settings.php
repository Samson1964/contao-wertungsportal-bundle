...
$GLOBALS['TL_LANG']['tl_settings']['wertungsportal_cron_aus'] = array('Nächtliches Vorladen abschalten', 'Ohne diesen Haken holt ein Cronjob nachts zwischen 1 und 3 Uhr alle zehn Minuten Turnierdaten und Karteikarten in den Zwischenspeicher, sofern dort noch nichts liegt — in dieser Reihenfolge: Turnierauswertungen, Turnierergebnisse, Karteikarten, Turnierhistorien, zuletzt die Spielberichtsbögen. Vorgeladen wird der gesamte örtliche Bestand, nicht nur die jüngsten Turniere. Ohne das Vorladen wartet jeweils der erste Besucher einer Seite auf die Schnittstelle. Jeder Lauf endet nach 300 Sekunden und der nächste macht dort weiter; der Lauf um 3 Uhr ist der letzte der Nacht. Erfolge stehen im Systemlog. ACHTUNG PLATZBEDARF: Ein vollständiger Durchlauf dauert mehrere Nächte und legt je Spieler zwei Einträge an (Karteikarte rund 4 KB, Turnierhistorie rund 32 KB) — bei 95.000 Spielern sind das etwa 3,4 GB, dazu die Turnierdaten. Näheres in docs/vorladen.md.');
...
$GLOBALS['TL_LANG']['tl_settings']['insert_verein_replaces'] = array('Ersetzungen im Vereinsnamen', 'Gilt für das Insert-Tag verein. Die Zeilen werden von oben nach unten angewandt, ohne Rücksicht auf Groß- und Kleinschreibung und nur an Wortgrenzen: Schachverein trifft „Schachverein Tempo", aber nicht „Schachvereinigung". Gekürzt wird erst danach. Näheres in docs/insert-tags.md.');
