...
(
	...
	(
		'tables'         => array
		(
			'tl_wertungsportal_sperren',
		),
		// Globale Operation: alte Einträge löschen (key=sperrenAufraeumen)
		'sperrenAufraeumen' => array('Schachbulle\ContaoWertungsportalBundle\Classes\Sperrenverwaltung', 'aufraeumen'),
	),
	'wp-elo'    => array
	(
		'tables'         => array
