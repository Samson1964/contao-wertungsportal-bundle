		...
		foreach($this->apiErgebnisse['body']['data'] as $partie)
		{
			...
			if(!$this->daten['Spieler'][$partie['whitePlayer']['playerNo']])
			{
				...
				(
					...
					'DWZ alt'        => \Schachbulle\ContaoWertungsportalBundle\Helper\Spielerwertung::aufbereiten($partie['whitePlayer'])['dwzAltKurz'],
			...
			if(!$this->daten['Spieler'][$partie['blackPlayer']['playerNo']])
			{
				...
				(
					...
					'DWZ alt'        => \Schachbulle\ContaoWertungsportalBundle\Helper\Spielerwertung::aufbereiten($partie['blackPlayer'])['dwzAltKurz'],
